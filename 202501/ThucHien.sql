...
----------------------------------------HCM_DT_LUYKE_002
Anh luu ý giúp em 2025 ko giao và tính doanh thu hi?n h?u di d?ng các AM,Line. 
Nên lúc ch?y k?t qu? th?c hi?n hi?n h?u di d?ng id606 lo?i giúp em doanh thu hi?n h?u luôn nhé, 
doanh thu PTM thì v?n tính bình thu?ng. (Các lo?i hình thuê bao Di dong tra sau, Cuocgoi_GDVP, Thoai_Home)
