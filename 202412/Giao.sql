...
delete from dinhbien_cuahang where thang=202412;
insert into dinhbien_cuahang 
select 202412,ma_to,ma_pb,dbien_tong,dbien_cht,dbien_kiem,dbien_gdv,dmuc_haumai_ch,to_number(ldong_tte_gdv)
  from temp_giao;

select * from dinhbien_cuahang where thang=202412;
select sum(dbien_tong),sum(dbien_cht),sum(dbien_kiem),sum(dbien_gdv),sum(ldong_tte_gdv),sum(dmuc_haumai_ch)
  from dinhbien_cuahang where thang=202412;
...
update bangluong_kpi a
   set giao=(select sum(dmuc_haumai_ch) from dinhbien_cuahang where thang=a.thang and ma_pb=a.ma_pb) 
       --   update bangluong_kpi a set giao=''
       --   select * from bangluong_kpi a
 where thang=202412 and ma_kpi='HCM_SL_CSKHH_003'
   and exists (select * from blkpi_danhmuc_kpi_vtcv 
                where thang=202412 and upper(ma_kpi)='HCM_SL_CSKHH_003' and giamdoc_phogiamdoc is not null
                  and ma_vtcv=a.ma_vtcv)
   and ma_nv in ('VNP016983','VNP017496','VNP017947','VNP017729','VNP016659')               
                  ;
 
                 

delete from bangluong_kpi a
--   select * from bangluong_kpi a
 where thang=202412 and ma_kpi='HCM_SL_CSKHH_003'
   and exists (select * from blkpi_danhmuc_kpi_vtcv 
                where thang=202412 and upper(ma_kpi)='HCM_SL_CSKHH_003' and giamdoc_phogiamdoc is not null
...
update bangluong_kpi a
   set giao=(select sum(tong_luyke) from ttkdhcm_ktnv.kehoach_606 where thang=a.thang and id_dv_606='0' and hrm=a.ma_nv)
       --   update bangluong_kpi a set giao=''
       --   select * from bangluong_kpi a
 where thang=202412 and ma_kpi='HCM_DT_LUYKE_002'    and ma_nv='VNP017331'
   and exists (select * from blkpi_danhmuc_kpi_vtcv 
...
update bangluong_kpi a
   set giao=(select sum(tong_luyke) from ttkdhcm_ktnv.kehoach_606 where thang=a.thang and id_dv_606='0' and to_hrm=a.ma_to)
       --   update bangluong_kpi a set giao=''
       --   select * from bangluong_kpi a
 where thang=202412 and ma_kpi='HCM_DT_LUYKE_002' --  and ma_nv='VNP020742'
   and exists (select * from blkpi_danhmuc_kpi_vtcv 
...
select (select distinct ma_nv from blkpi_dm_to_pgd 
 ...
 where thang=202412 and id_dv_606='0'
)group by ma_nv;
...
update bangluong_kpi a
   set giao=(select dthu from temp_bsc_giao where ma_nv=a.ma_nv)
       --   update bangluong_kpi a set giao=''
       --   select * from bangluong_kpi a
 where thang=202412 and ma_kpi='HCM_DT_LUYKE_002'    --and ma_nv='VNP017763'
   and exists (select * from blkpi_danhmuc_kpi_vtcv 
...
--delete from bangluong_kpi a
 where thang=202412 and ma_kpi='HCM_DT_LUYKE_003' and ma_nv='VNP017445';
...
update bangluong_kpi a
   set giao=(select sum(tong_luyke) from ttkdhcm_ktnv.kehoach_606 where thang=a.thang and id_dv_606='1.1' and hrm=a.ma_nv)
      --   update bangluong_kpi a set giao=''
       --   select * from bangluong_kpi a
 where thang=202412 and ma_kpi='HCM_DT_LUYKE_003'  -- and ma_nv='VNP017331'
   and exists (select * from blkpi_danhmuc_kpi_vtcv 
...
update bangluong_kpi a
   set giao=(select sum(tong_luyke) from ttkdhcm_ktnv.kehoach_606 where thang=a.thang and id_dv_606='1.1' and to_hrm=a.ma_to)
       --   update bangluong_kpi a set giao=''
       --   select * from bangluong_kpi a
 where thang=202412 and ma_kpi='HCM_DT_LUYKE_003'    --and ma_nv='VNP020742'
   and exists (select * from blkpi_danhmuc_kpi_vtcv 
...
select (select distinct ma_nv from blkpi_dm_to_pgd 
       ...
       ,tong_luyke
  from ttkdhcm_ktnv.kehoach_606 a
 where thang=202412 and id_dv_606='1.1'
)group by ma_nv;
...
update bangluong_kpi a
   set giao=(select dthu from temp_bsc_giao where ma_nv=a.ma_nv)
       --   update bangluong_kpi a set giao=''
       --   select * from bangluong_kpi a
 where thang=202412 and ma_kpi='HCM_DT_LUYKE_003'   -- and ma_nv='VNP017763'
   and exists (select * from blkpi_danhmuc_kpi_vtcv 
...
select * from bangluong_kpi
--delete from bangluong_kpi a
 where thang=202412 and ma_kpi='HCM_DT_PTNAM_006' and ma_nv='VNP017445';
...
select distinct ten_kpi from ttkdhcm_ktnv.ID372_GIAO_C2_CHOTTHANG where thang=202412;

select a.*,(select ten_vtcv from nhanvien where thang=202412 and ma_nv=a.ma_nv)  
  from ttkdhcm_ktnv.ID372_GIAO_C2_CHOTTHANG a 
 where thang=202412 and ten_kpi like '4.%';


select * from ttkdhcm_ktnv.ID372_GIAO_C2_CHOTTHANG where thang=202412 and ten_kpi like '4.%' and ma_nv in(
select ma_nv from ttkdhcm_ktnv.ID372_GIAO_C2_CHOTTHANG where thang=202412 and ten_kpi like '4.%' group by ma_nv having count(*)>1)


update bangluong_kpi a
   set giao=(select sum(sogiao) from ttkdhcm_ktnv.ID372_GIAO_C2_CHOTTHANG where thang=202412 and ten_kpi like '4.%' and ma_nv=a.ma_nv)
       --update bangluong_kpi a set giao=''
       --select * from bangluong_kpi a
...
(select ma_nv,sogiao
  from ttkdhcm_ktnv.ID372_GIAO_C2_CHOTTHANG a
 where thang=202412 and ten_kpi like '4.%' and ma_nv is not null
 and ma_pb in ('VNP0702300','VNP0702400','VNP0702500')
 )x
 full join 
 (select ma_nv,giao from bangluong_kpi a
 where thang=202412 and ma_kpi='HCM_DT_PTMOI_054' and giao is not null)y
 on x.ma_nv=y.ma_nv
 where sogiao<>giao
...
select 'id372'nd,count(*)sl,sum(sogiao)giao from ttkdhcm_ktnv.ID372_GIAO_C2_CHOTTHANG a
 where thang=202412 and ten_kpi like '4.%' and ma_nv is not null 
   and ma_pb in ('VNP0702300','VNP0702400','VNP0702500')
 union 
select 'bangluong',count(*)sl,sum(giao)giao from bangluong_kpi where thang=202412 and ma_kpi='HCM_DT_PTMOI_054' and giao is not null;
 

select x.ma_vtcv ma_vtcv_id372,y.ma_vtcv ma_vtcv_dm_vtcv 
      ,(select ten_vtcv from nhanvien where thang=202412 and ma_vtcv=nvl(x.ma_vtcv,y.ma_vtcv) and rownum=1)ten_vtcv
  from (select distinct (select ma_vtcv from nhanvien where thang=202412 and ma_nv=a.ma_nv)ma_vtcv  
          from ttkdhcm_ktnv.ID372_GIAO_C2_CHOTTHANG a 
         where thang=202412 and ten_kpi like '4.%')x
       full join 
       (select * from blkpi_danhmuc_kpi_vtcv where thang=202412 and ma_kpi='HCM_DT_PTMOI_054')y
...
select ma_nv,sum(sogiao)sogiao,(select ma_pb from nhanvien where thang=202412 and ma_nv=b.ma_nv)ma_pb
  from( 
select sogiao
  ...
  from ttkdhcm_ktnv.ID372_GIAO_C2_CHOTTHANG a
 where thang=202412 and ten_kpi like '4.%' and ten_to like 'NV-%' and ma_pb in ('VNP0702300','VNP0702400','VNP0702500')
)b group by ma_nv;
...
select 'id372'nd,ma_pb,sogiao 
 ...
 where thang=202412 and ten_kpi like '4.%' and ma_pb is not null and ma_nv is null
 union
...
update bangluong_kpi a
   set tytrong=case when exists(select * from blkpi_danhmuc_kpi_vtcv 
                                 where thang=202412 and upper(ma_kpi)='HCM_DT_PTMOI_054' 
...
update bangluong_kpi a 
   set giao=(select count(*) from nhanvien where ma_vtcv='VNP-HNHCM_KHDN_23' and thang=a.thang and ma_to=a.ma_to)
       --select * from bangluong_kpi a
       --update bangluong_kpi a set giao=''
 where thang=202412 and ma_kpi='HCM_SL_DAILY_003'
   and exists(select * from ttkd_bsc.blkpi_danhmuc_kpi_vtcv 
...
update bangluong_kpi set giao='' where thang=202412 and ma_kpi='HCM_SL_DAILY_003' and giao=0;
