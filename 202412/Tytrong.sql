...
update bangluong_kpi a
   set tytrong=case when ma_vtcv='VNP-HNHCM_KHDN_3' then 45
                    when ma_vtcv='VNP-HNHCM_KHDN_23' then 70
                    when ma_vtcv='VNP-HNHCM_KHDN_4' then case when ma_to='VNP0702309' then 70 else 40 end
...
----------------------------- HCM_DT_LUYKE_003
delete from bangluong_kpi where thang=202412 and ma_to='VNP0702309' and ma_vtcv='VNP-HNHCM_KHDN_4' and ma_kpi='HCM_DT_LUYKE_003';

update bangluong_kpi a
   set tytrong=case when ma_vtcv='VNP-HNHCM_KHDN_3' then 15
                    when ma_vtcv='VNP-HNHCM_KHDN_4' then 15
                    when ma_vtcv='VNP-HNHCM_KHDN_2' then 
...
----------------------------- HCM_DT_PTNAM_006
delete from bangluong_kpi where thang=202412 and ma_to='VNP0702309' and ma_vtcv='VNP-HNHCM_KHDN_4' and ma_kpi='HCM_DT_PTNAM_006';

update bangluong_kpi a
   set tytrong=case when ma_vtcv='VNP-HNHCM_KHDN_3' then 20
                    when ma_vtcv='VNP-HNHCM_KHDN_4' then 25
                    when ma_vtcv='VNP-HNHCM_KHDN_2' then 
                         case when ma_nv in ('VNP022074','VNP017621','VNP017699') then 10  --CSKH
                              else 25
                          end
...
update bangluong_kpi a
   set tytrong=case when ma_vtcv='VNP-HNHCM_KHDN_3' then 10
                    when ma_vtcv='VNP-HNHCM_KHDN_23' then 10
...
--------------------- HCM_SL_DAILY_003
update bangluong_kpi a 
   set tytrong=case when ma_vtcv='VNP-HNHCM_KHDN_23' then 10
